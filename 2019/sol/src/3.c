...
int read_wire_files(char *filename, const int bufsize, Segment_t *wire1, int *wire1_length,
...
int walk_wire(const int wire_length, Segment_t *wire, const int num_intersections,
              Point_t *buffer_intersections, int *step_counts)
{
    int steps = 0;
...
int solve_2019_3_2(char *input_filename)
{
    ...
    if (walk_wire(wire1_length, wire1, num_intersections, buffer_intersections, step_counts1) ==
            -1 ||
