...
typedef class IntcodeTest : public Utest
{
  public:
    ...
    IntcodeReturn_t test_program(Intcode_t *program, int input_count, long *input_buffer,
                                 int expected_output_count, long *output_buffer)
    {
        ...
        while (1)
        {
            IntcodeReturn_t retval =
                run_intcode(program, input_count - num_inputs_used, input_buffer + num_inputs_used);
