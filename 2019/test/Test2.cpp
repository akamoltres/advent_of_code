...
{
    void run_test(const int bufsize, int *buffer,
                  int *expected_end, int expected_last_pc)
    {
...
TEST(INTCODE_DAY2, TEST0)
{
    ...
    int buffer[bufsize] = {1,9,10,3,2,3,11,0,99,30,40,50};
...
{
    const int bufsize = 6;
    int buffer[bufsize] = {2,4,4,5,99,0};
...
{
    const int bufsize = 9;
    int buffer[bufsize] = {1,1,1,4,99,5,6,0,99};
